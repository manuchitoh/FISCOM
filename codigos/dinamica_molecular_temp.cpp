...
const int steps = 10000; // Número de pasos
...
int main() {
    ...
    // Abro los archivos
    std::ofstream outfileE("energia_dinamica_molecular_temp.dat");
    std::ofstream outfileV("velocidades_temp.dat");
    std::ofstream outfileR("posiciones_temp.dat");
